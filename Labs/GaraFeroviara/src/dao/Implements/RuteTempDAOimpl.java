...
public class RuteTempDAOimpl implements RuteDAO {

    private static final String SQL_INSERT = "INSERT INTO public.\"RuteTemp\"(\"DataPlecarii\", \"OraPlecarii\", \"LocatieInitiala\", \"DataSosirii\", \"OraSosirii\", \"Destinatie\", \"Durata\", \"NrSaptamanii\", \"LocuriDisponibileConfort\", \"LocuriConfort\", \"PretConfort\", \"LocuriDisponibileEco\", \"LocuriEco\", \"PretEco\", \"IDZiua\") VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?);";
    private static final String SQL_SELECT_ALL = "SELECT \"CodCursa\", \"DataPlecarii\", \"OraPlecarii\", \"LocatieInitiala\", \"DataSosirii\", \"OraSosirii\", \"Destinatie\", \"Durata\", \"NrSaptamanii\", \"LocuriDisponibileConfort\", \"LocuriConfort\", \"PretConfort\", \"LocuriDisponibileEco\", \"LocuriEco\", \"PretEco\", \"IDZiua\" FROM public.\"RuteTemp\";";
    private static final String SQL_SELECT_BY_ID = "SELECT \"CodCursa\", \"DataPlecarii\", \"OraPlecarii\", \"LocatieInitiala\", \"DataSosirii\", \"OraSosirii\", \"Destinatie\", \"Durata\", \"NrSaptamanii\", \"LocuriDisponibileConfort\", \"LocuriConfort\", \"PretConfort\", \"LocuriDisponibileEco\", \"LocuriEco\", \"PretEco\", \"IDZiua\" FROM public.\"RuteTemp\" WHERE \"CodCursa\" = ?;";
    private static final String SQL_DELETE_BY_ID = "DELETE FROM public.\"RuteTemp\" WHERE \"CodCursa\"=?;";
    private static final String SQL_DELETE_BY_OBJECT = "DELETE FROM public.\"RuteTemp\" WHERE \"DataPlecarii\" = ? and \"OraPlecarii\" = ? and \"LocatieInitiala\" = ? and \"DataSosirii\" = ? and \"OraSosirii\" = ? and \"Destinatie\" = ? and \"Durata\" = ? and \"NrSaptamanii\" = ? and \"LocuriDisponibileConfort\" = ? and \"LocuriConfort\" = ? and \"PretConfort\" = ? and \"LocuriDisponibileEco\" = ? and \"LocuriEco\" = ? and \"PretEco\" = ? and \"IDZiua\" = ? ;";
    private static final String SQL_UPDATE = "UPDATE public.\"RuteTemp\" SET \"DataPlecarii\"=?, \"OraPlecarii\"=?, \"LocatieInitiala\"=?, \"DataSosirii\"=?, \"OraSosirii\"=?, \"Destinatie\"=?, \"Durata\"=?, \"NrSaptamanii\"=?, \"LocuriDisponibileConfort\"=?, \"LocuriConfort\"=?, \"PretConfort\"=?, \"LocuriDisponibileEco\"=?, \"LocuriEco\"=?, \"PretEco\"=?, \"IDZiua\"=? WHERE \"CodCursa = ?\";";
