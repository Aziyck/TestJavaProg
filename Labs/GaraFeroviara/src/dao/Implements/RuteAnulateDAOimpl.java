...
public class RuteAnulateDAOimpl implements RuteDAO {
    ...
    private static final String SQL_INSERT = "INSERT INTO public.\"RuteAnulate\"(\"DataPlecarii\", \"OraPlecarii\", \"LocatieInitiala\", \"DataSosirii\", \"OraSosirii\", \"Destinatie\", \"Durata\", \"NrSaptamanii\", \"LocuriDisponibileConfort\", \"LocuriConfort\", \"PretConfort\", \"LocuriDisponibileEco\", \"LocuriEco\", \"PretEco\", \"IDZiua\") VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?);";
    private static final String SQL_SELECT_ALL = "SELECT \"CodCursa\", \"DataPlecarii\", \"OraPlecarii\", \"LocatieInitiala\", \"DataSosirii\", \"OraSosirii\", \"Destinatie\", \"Durata\", \"NrSaptamanii\", \"LocuriDisponibileConfort\", \"LocuriConfort\", \"PretConfort\", \"LocuriDisponibileEco\", \"LocuriEco\", \"PretEco\", \"IDZiua\" FROM public.\"RuteAnulate\";";
    private static final String SQL_SELECT_BY_ID = "SELECT \"CodCursa\", \"DataPlecarii\", \"OraPlecarii\", \"LocatieInitiala\", \"DataSosirii\", \"OraSosirii\", \"Destinatie\", \"Durata\", \"NrSaptamanii\", \"LocuriDisponibileConfort\", \"LocuriConfort\", \"PretConfort\", \"LocuriDisponibileEco\", \"LocuriEco\", \"PretEco\", \"IDZiua\" FROM public.\"RuteAnulate\" WHERE \"CodCursa\" = ?;";
    private static final String SQL_DELETE_BY_ID = "DELETE FROM public.\"RuteAnulate\" WHERE \"CodCursa\"=?;";
    private static final String SQL_DELETE_BY_OBJECT = "DELETE FROM public.\"RuteAnulate\" WHERE \"DataPlecarii\" = ? and \"OraPlecarii\" = ? and \"LocatieInitiala\" = ? and \"DataSosirii\" = ? and \"OraSosirii\" = ? and \"Destinatie\" = ? and \"Durata\" = ? and \"NrSaptamanii\" = ? and \"LocuriDisponibileConfort\" = ? and \"LocuriConfort\" = ? and \"PretConfort\" = ? and \"LocuriDisponibileEco\" = ? and \"LocuriEco\" = ? and \"PretEco\" = ? and \"IDZiua\" = ? ;";
    private static final String SQL_UPDATE = "UPDATE public.\"RuteAnulate\" SET \"DataPlecarii\"=?, \"OraPlecarii\"=?, \"LocatieInitiala\"=?, \"DataSosirii\"=?, \"OraSosirii\"=?, \"Destinatie\"=?, \"Durata\"=?, \"NrSaptamanii\"=?, \"LocuriDisponibileConfort\"=?, \"LocuriConfort\"=?, \"PretConfort\"=?, \"LocuriDisponibileEco\"=?, \"LocuriEco\"=?, \"PretEco\"=?, \"IDZiua\"=? WHERE \"CodCursa = ?\";";
