...
//        calculateDinamicLenghOfCells(1);
    ...
    public void addCountToTableAndDinamicCellLLength() throws Exception {
        header.add(0, "Nr");
        ...
        calculateDinamicLenghOfCells();
    }

    public void addCountToTableAndDinamicCellLLength(int plusSpaces) throws Exception {
        header.add(0, "Nr");
        ...
        calculateDinamicLenghOfCells(plusSpaces);
    }
